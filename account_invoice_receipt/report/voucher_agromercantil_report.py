...
#DELETE FROM ir_act_report_xml WHERE report_name = 'account.payment.voucher.agromercantil'
...
class voucher_agromercantil_report(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context):
        super(voucher_agromercantil_report, self).__init__(cr, uid, name, context)
...
report_sxw.report_sxw('report.account.payment.voucher.agromercantil', 'account.voucher', 'addons/account_invoice_receipt/report/voucher_agromercantil_report.rml', parser=voucher_agromercantil_report, header=False)
