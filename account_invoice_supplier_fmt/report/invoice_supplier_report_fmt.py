    ...
    def invoice_lines(self, invoice):
        ...
        for entry in invoice_list:
            ...
            if entry.state == 'article':
                ...
                res['account_code'] = entry.account_id.code
                res['analityc_account_code'] = entry.account_analytic_id.code
            ...
            result.append(res)
        return result
report_sxw.report_sxw('report.account.invoice.supplier.fmt', 'account.invoice', 'addons/account_invoice_supplier/report/report_account_invoice_supplier.rml', parser=account_invoice_1)
